...
import ru.practicum.event.dto.category.*;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public CategoryDto getCategory(Long id) {
        ...
        Category category = categoryRepository.findById(id).orElseThrow(() -> new NotFoundException(String.format("Category с id=%d не найден", id)));
